...
namespace HNFactoryModbusServer.Modbus
{
    ...
    {
        public static short StartingAddress = short.Parse(ConfigurationManager.AppSettings["StartingAddress"]);
        ...
        public ModBusTCPIPWrapper(string strPLCServerIP, int iPLCServerPort) : base(strPLCServerIP, iPLCServerPort) { }
